...
//        moveCamera(e);
    ...
    {
//        Debugger.println("============= Zoom camera ============");
        zoomCamera(e);
    }

    private void moveCamera(MouseEvent e)
    {
//        Debugger.println("============= Move camera ============");
        try
        {
    ...
    {
//        Debugger.println("Model -> Screen Transformation:");
//        showMatrix(coordTransform);

        AffineTransform inverse = coordTransform.createInverse();

        //        Debugger.println("Screen -> Model Transformation:");
//        showMatrix(inverse);
