...
/** Token Manager. */
public class NewickTokenManager implements NewickConstants
{
...
/** Constructor. */
public NewickTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public NewickTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
